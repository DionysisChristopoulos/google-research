...
def get_config():
  ...
  config.sample.gen_data_dir = './Datasets/Checkpoints/sen12ms_colorizer_128_conv/samples_core_test'
  config.sample.log_dir = 'samples_sup_test'
  config.sample.batch_size = 7
